...
import {useDeleteQuizzeMutation} from "../../../features/quizzes/quizzesApi";

function QuizItem(quiz) {
    console.log(quiz);
    const  navigate = useNavigate();
    const [deleteQuizzeMutation, { loading, error, data }] = useDeleteQuizzeMutation();
    const handleDelete = () =>{
        ...
        <tr>
            ...
            <td className="table-td flex gap-x-2 justify-center">
                <svg fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor"
                    ...
                    <path stroke-linecap="round" onClick={handleDelete} stroke-linejoin="round"
